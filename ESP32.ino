...
// ===== WebSocket Server =====
const char* ws_host = "ipของคอมพิวเตอร์ที่รันเซิร์ฟเวอร์";  // 🔥 เปลี่ยนเป็น IP ของคอมพิวเตอร์ที่รันเซิร์ฟเวอร์
const int ws_port = ;// 🔥 เปลี่ยนเป็นพอร์ตที่เซิร์ฟเวอร์ใช้
